...
export const ManchesterRoutes = [
  ...
  <Route key="salford" path="/manchester/salford" element={<SalfordBroadband />} />,
  <Route key="trafford" path="/manchester/trafford" element={<TraffordBroadband />} />,
  <Route key="stockport" path="/manchester/stockport" element={<StockportBroadband />} />,
  <Route key="bolton" path="/manchester/bolton" element={<BoltonBroadband />} />,
