...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="container mx-auto px-[50px] py-[30px] md:py-0">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <h1 className="text-4xl sm:text-4xl md:text-6xl font-bold tracking-tight leading-tight bg-gradient-to-r from-primary to-pink-500 bg-clip-text text-transparent">
              Smart choices,
              <br />
            ...
            <Button 
              className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          ...
          <div className="hidden md:block relative">
            <div className="absolute -z-10 w-96 h-96 bg-pink-200 rounded-full blur-3xl opacity-20 -top-10 -right-10"></div>
            <img 
      ...
      {/* Services Section */}
      <section id="services-section" className="bg-gradient-to-b from-gray-50 to-white py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-pink-500 bg-clip-text text-transparent">
              Compare deals, switch and save
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <ServiceCard
              ...
              buttonColor="bg-gradient-to-r from-cyan-400 to-cyan-500"
            />
            <ServiceCard
              title="Mobile phones"
      ...
      {/* Why Compare Section */}
      <section className="bg-gradient-to-br from-[#1a1f2c] to-[#2d3748] text-white py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-pink-400 to-pink-200 bg-clip-text text-transparent">
              Why compare with us?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white/5 backdrop-blur-lg p-8 rounded-2xl text-center animate-fade-in hover:transform hover:scale-105 transition-all duration-300 border border-white/10">
              <Diamond className="w-12 h-12 mx-auto mb-4 text-pink-400" />
              <h3 className="text-xl font-bold mb-3 text-white">Unique Offers</h3>
            ...
            <div className="bg-white/5 backdrop-blur-lg p-8 rounded-2xl text-center animate-fade-in hover:transform hover:scale-105 transition-all duration-300 border border-white/10">
              <Handshake className="w-12 h-12 mx-auto mb-4 text-pink-400" />
              <h3 className="text-xl font-bold mb-3 text-white">Trusted Advice</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-white/5 backdrop-blur-lg p-8 rounded-2xl text-center animate-fade-in hover:transform hover:scale-105 transition-all duration-300 border border-white/10">
              <ShieldCheck className="w-12 h-12 mx-auto mb-4 text-pink-400" />
              <h3 className="text-xl font-bold mb-3 text-white">Simple Switch</h3>
              <p className="text-gray-300">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="mb-4">Stay up to date with our latest offers and updates</p>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-sm">© 2024 Smartfony. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
