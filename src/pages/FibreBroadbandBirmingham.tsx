...
const FibreBroadbandBirmingham = () => {
  ...
  return (
    <CitystyleTemplate>
      <Helmet>
        <title>Fibre Broadband Birmingham | Compare Fast Internet Deals</title>
        <meta 
          name="description" 
          content="Looking for fibre broadband in Birmingham? Compare ultra-fast packages from top providers. Get reliable speeds for streaming, gaming & home working."
        />
      </Helmet>

      <CitystyleHero
        title="Fibre Broadband in Birmingham"
        subtitle="Find the fastest and most reliable fibre broadband deals in Birmingham. Compare packages from leading providers to get the best value for your home."
      ...
      <CitystyleContent>
        <CitystyleFeatureGrid
          title="Why Choose Fibre Broadband in Birmingham?"
          subtitle="Experience lightning-fast internet speeds with local fibre broadband deals"
        >
          <CitystyleFeatureCard
            icon={Wifi}
            title="Ultra-Fast Speeds"
            description="Get download speeds up to 1Gbps with full fibre coverage across Birmingham"
          />
          <CitystyleFeatureCard
            icon={Globe}
            title="City-Wide Coverage"
            description="Extensive fibre network covering all Birmingham neighborhoods"
          />
          <CitystyleFeatureCard
            icon={House}
            title="Home-Ready"
...
export default FibreBroadbandBirmingham;