...
import { Wifi, Signal, House, Laptop, Users, Router } from 'lucide-react';
...
const StudentBroadbandPortsmouth = () => {
  ...
  return (
    <CitystyleTemplate>
      <Helmet>
        <title>Student Broadband Portsmouth | University Internet Deals</title>
        <meta 
          name="description" 
          content="Compare student broadband deals in Portsmouth. Find flexible contracts and fast internet perfect for university accommodation. Student-friendly packages available."
        />
      </Helmet>

      <CitystyleHero
        title="Student Broadband in Portsmouth"
        subtitle="Find the perfect internet package for your student accommodation. Compare deals with flexible contracts ideal for term-time."
        image="/lovable-uploads/a3e27fb1-bf74-4467-abae-439ef1db7051.png"
        imageAlt="Portsmouth student broadband deals"
      ...
      <CitystyleContent>
        ...
        <CitystyleFeatureGrid
          ...
          subtitle="Get connected with packages designed for university life"
        >
          <CitystyleFeatureCard
            icon={Wifi}
            title="Fast Speeds"
            description="Perfect for streaming lectures and gaming"
          />
          <CitystyleFeatureCard
            icon={Signal}
            title="Flexible Contracts"
            description="9-month terms to match the academic year"
          />
          <CitystyleFeatureCard
            icon={House}
            title="Student-Friendly"
            description="Ideal for shared student houses"
          />
        </CitystyleFeatureGrid>
      </CitystyleContent>
    </CitystyleTemplate>
