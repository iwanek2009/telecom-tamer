      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="text-center space-y-4">
            <h3 className="text-xl font-bold text-gray-900">Seaside-Ready Speeds</h3>
          ...
          <div className="text-center space-y-4">
            <h3 className="text-xl font-bold text-gray-900">Perfect For Local Living</h3>
            <p className="text-gray-600">
              From Albert Road creatives to families near Canoe Lake, choose packages that match your Southsea lifestyle and budget.
            </p>
          </div>
          <div className="text-center space-y-4">
            <h3 className="text-xl font-bold text-gray-900">Local Coverage You Can Trust</h3>
            <p className="text-gray-600">
