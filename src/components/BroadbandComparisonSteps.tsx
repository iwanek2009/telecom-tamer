      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#E5F9FA] to-[#F0FCFD] backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#3FC1C9]/20 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Choose your perfect package</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-gradient-to-br from-[#E5F9FA] to-[#F0FCFD] backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#3FC1C9]/20 text-center">
            ...
            <p className="text-gray-600">
              Complete your order through the provider's website. Don't worry - you'll have 14 days to change your mind with no charges.
            </p>
          </div>
        </div>
      </div>
